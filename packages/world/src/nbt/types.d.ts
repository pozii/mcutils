export declare const NBT_TAG_END = 0;
export declare const NBT_TAG_BYTE = 1;
export declare const NBT_TAG_SHORT = 2;
export declare const NBT_TAG_INT = 3;
export declare const NBT_TAG_LONG = 4;
export declare const NBT_TAG_FLOAT = 5;
export declare const NBT_TAG_DOUBLE = 6;
export declare const NBT_TAG_BYTE_ARRAY = 7;
export declare const NBT_TAG_STRING = 8;
export declare const NBT_TAG_LIST = 9;
export declare const NBT_TAG_COMPOUND = 10;
export declare const NBT_TAG_INT_ARRAY = 11;
export declare const NBT_TAG_LONG_ARRAY = 12;
export type NbtTag = NbtTagEnd | NbtTagByte | NbtTagShort | NbtTagInt | NbtTagLong | NbtTagFloat | NbtTagDouble | NbtTagByteArray | NbtTagString | NbtTagList | NbtTagCompound | NbtTagIntArray | NbtTagLongArray;
