...
export async function readLevelDat(worldDir) {
...
export function readLevelDatSync(worldDir) {
    const filePath = path.join(worldDir, 'level.dat');
...
function extractWorldInfo(data) {
    return {
...
function extractRaw(data) {
    ...
    return toJson(data, { simplify: true });
}
export async function listWorlds(serverDir) {
...
export function listWorldsSync(serverDir) {
